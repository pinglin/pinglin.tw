...
[a model alone cannot unlock the full AI value chain](https://www.instill.tech/blog/unstructured-data-etl).

### One-step Unstructured Data ETL (2022)

Based on our thesis, we [originally](https://www.instill.tech/blog/why-instill-ai-exists) identified our target audience as Data Engineers, Data
...
Today, you can use [Instill Core](https://github.com/instill-ai/instill-core) to build chatbots,
[plant phenotype analyzer](https://www.instill.tech/blog/abrc-customer-success),
[complex PDF parser](https://www.instill.tech/blog/make-complex-documents-rag-ready),
[crawl websites](https://www.instill.tech/blog/semantic-web-crawler-insights-unstructured-data-ai), or even
[an advanced RAG system](https://www.instill.tech/blog/rag-tutorial) for AI agents' tools. Wait... AI agent? Isn't that yet another pedantic buzzword
in this article? Well, at Instill AI, we view all AI-first applications and tasks as unstructured data ETL pipelines. [Video 1](#video-1) and
[Video 2](#video-2) offer a glimpse into what this looks like in action.
...
I'd like to thank my co-founder, [Xiaofei](https://www.linkedin.com/in/xiaofeidu), for being both a friend and mentor, constantly generating brilliant
ideas day and night, and tirelessly working alongside me to build Instill AI.

Of course, this incredible product journey would not have been possible without the dedication, hard work, and passion of the entire Instill AI team.

A heartfelt thank you to [George](https://www.linkedin.com/in/georgewstrong) and [Leo](https://www.linkedin.com/in/tychen5) for their passionate
discussions and meticulous planning, which shaped the multi-agent framework. A huge thanks to [Dani](https://www.linkedin.com/in/sosadaniel) for
bringing our product vision to life through UI/UX design and for your patience in working with a terminal-heavy user like me.

To [Po-Chun](https://www.linkedin.com/in/po-chun-chiu-05103285) and [Alexander](http://linkedin.com/in/rckt), thank you for your pixel-perfect
execution, ensuring that every UI element is crafted with precision. A special thanks to [Hui-Tang](https://www.linkedin.com/in/changhuitang),
[Heiru](https://www.linkedin.com/in/heiruwu), and [Juan](https://github.com/jvallesm) for building and maintaining the solid backbone of our tech
stack. [Sarthak](https://www.linkedin.com/in/sarthak-kg-bb887b239), I appreciate your work in managing our infrastructure and fostering a strong
DevOps culture.

A big shoutout to [Moto](https://www.linkedin.com/in/moto-mo) for your exceptional product management skills, ensuring every detail is pinned down,
aligned, and kept on schedule. Thank you to [Shih-Chun](https://www.linkedin.com/in/shih-chun-huang) and
[Andy](https://www.linkedin.com/in/andyellicott) for leading marketing and campaign efforts. Many of our key decisions have been informed by the
market signals you've helped us analyze. Minji, thank you for handling back-office operations and always stepping in to put out fires when needed.

Last but not least, my deepest gratitude to our investors, who believe in the team and our vision. [Yan](https://www.linkedin.com/in/yanlee), your
unwavering support for me and Xiaofei has been invaluable. [Tom](https://www.linkedin.com/in/tomfsheridan) and
[Gareth](https://www.linkedin.com/in/gareth-jefferies), thank you for leading our seed round, and [Morris](https://www.linkedin.com/in/morris-clay),
for always helping us navigate the company's direction. [Charles](https://www.linkedin.com/in/charlessonghurst), I truly appreciate your advices and
strategic insights.

This journey has been a collective effort, and I am deeply grateful to be working alongside such incredible people.
