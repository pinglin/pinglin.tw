...
Vision。這是一段從零開始打造公司的旅程。作為 CTO，我貢獻了我的技術專長，但最終還是說服不了自己要繼續在那邊當共同創辦人。當時，基於深度學習的電腦視覺演演算法還是個新領域（像是卷積神經網路 ConvNets，包括 AlexNet、VGG、ResNet、YOLO 等等）。
...
AI。我們在研究室共事多年，她在拿到博士學位後也加入過 Umbo。我們對 AI 應該如何被實作和採用成為軟體基礎建設，有著共同的想法。

創立 Instill AI 至今已經四年了。我們一直專注在實踐對非結構化資料 ETL 的堅定信仰。處理非結構化資料應該要跟處理結構化資料一樣容易。Instill
Core 就是我們實現理想中非結構化資料 ETL 工具的開源計畫。我們對它的設計和架構一直都很有自己的想法。
...
- 巨頭們為了壟斷市場而競爭，加速了基礎模型和基礎建設的商品化（就像雲端運算和大資料時代發生過的事情一樣）
